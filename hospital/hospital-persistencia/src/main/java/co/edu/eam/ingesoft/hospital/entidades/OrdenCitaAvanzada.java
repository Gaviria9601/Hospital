...
public class OrdenCitaAvanzada implements Serializable {
	...
	/**
	 * @param medicoUsuarioCedula
	 *            the medicoUsuarioCedula to set
	 */
	...
	/**
	 * @param instalacionCodigo
	 *            the instalacionCodigo to set
	 */
	...
	/**
	 * @param citaAvanzadaCodigo
	 *            the citaAvanzadaCodigo to set
	 */
